...
$updated_license_key =  isset($_REQUEST['wpsp_addon_license']) && isset($_REQUEST['wpsp_addon_license']['caa']) ? sanitize_text_field(trim($_REQUEST['wpsp_addon_license']['caa'])) : '';
...
update_option( 'wpsp_license_key_condagentassign', $updated_license_key );
