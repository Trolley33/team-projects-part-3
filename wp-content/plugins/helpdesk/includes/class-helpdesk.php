...
class Helpdesk
{
    ...
    private function define_public_hooks()
    {
        ...
        $this->loader->add_action('wp_ajax_follow_thread', $plugin_public, 'RUN AJAX FUNCTION');
        $this->loader->add_action('wp_ajax_nopriv_follow_thread', $plugin_public, 'RUN AJAX FUNCTION');
